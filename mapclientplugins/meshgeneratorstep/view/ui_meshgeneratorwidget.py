...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -295, 316, 1070))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout = QtGui.QFormLayout(self.blackfynn_groupBox)
        self.formLayout.setObjectName("formLayout")
        self.blackfynnDataset_label = QtGui.QLabel(self.blackfynn_groupBox)
        self.blackfynnDataset_label.setObjectName("blackfynnDataset_label")
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.blackfynnDataset_label)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.blackfynnTimeSeries_label)
        self.blackfynnDataset_lineEdit = QtGui.QLineEdit(self.blackfynn_groupBox)
        self.blackfynnDataset_lineEdit.setObjectName("blackfynnDataset_lineEdit")
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.blackfynnDataset_lineEdit)
        self.blackfynnTimeSeries_lineEdit = QtGui.QLineEdit(self.blackfynn_groupBox)
        self.blackfynnTimeSeries_lineEdit.setObjectName("blackfynnTimeSeries_lineEdit")
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.blackfynnTimeSeries_lineEdit)
        self.blackfynnShowEEG_checkBox = QtGui.QCheckBox(self.blackfynn_groupBox)
        self.blackfynnShowEEG_checkBox.setObjectName("blackfynnShowEEG_checkBox")
        self.formLayout.setWidget(1, QtGui.QFormLayout.SpanningRole, self.blackfynnShowEEG_checkBox)
        self.blackfynnCredentials_groupBox = QtGui.QGroupBox(self.blackfynn_groupBox)
        self.blackfynnCredentials_groupBox.setObjectName("blackfynnCredentials_groupBox")
        self.formLayout_2 = QtGui.QFormLayout(self.blackfynnCredentials_groupBox)
        self.formLayout_2.setObjectName("formLayout_2")
        self.blackfynnCredentialsLogin_pushButton = QtGui.QPushButton(self.blackfynnCredentials_groupBox)
        self.blackfynnCredentialsLogin_pushButton.setObjectName("blackfynnCredentialsLogin_pushButton")
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.LabelRole, self.blackfynnCredentialsLogin_pushButton)
        self.blackfynnCredentialsAPISecret_lineEdit = QtGui.QLineEdit(self.blackfynnCredentials_groupBox)
        self.blackfynnCredentialsAPISecret_lineEdit.setObjectName("blackfynnCredentialsAPISecret_lineEdit")
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.SpanningRole, self.blackfynnCredentialsAPISecret_lineEdit)
        self.blackfynnCredentialsAPIKey_lineEdit = QtGui.QLineEdit(self.blackfynnCredentials_groupBox)
        self.blackfynnCredentialsAPIKey_lineEdit.setObjectName("blackfynnCredentialsAPIKey_lineEdit")
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.SpanningRole, self.blackfynnCredentialsAPIKey_lineEdit)
        self.formLayout.setWidget(0, QtGui.QFormLayout.SpanningRole, self.blackfynnCredentials_groupBox)
    ...
    def retranslateUi(self, MeshGeneratorWidget):
        ...
        self.blackfynnShowEEG_checkBox.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Show EEG data in animation", None, QtGui.QApplication.UnicodeUTF8))
        self.blackfynnCredentials_groupBox.setTitle(QtGui.QApplication.translate("MeshGeneratorWidget", "Credentials:", None, QtGui.QApplication.UnicodeUTF8))
        self.blackfynnCredentialsLogin_pushButton.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Login", None, QtGui.QApplication.UnicodeUTF8))
        self.blackfynnCredentialsAPISecret_lineEdit.setPlaceholderText(QtGui.QApplication.translate("MeshGeneratorWidget", "API Secret", None, QtGui.QApplication.UnicodeUTF8))
        self.blackfynnCredentialsAPIKey_lineEdit.setPlaceholderText(QtGui.QApplication.translate("MeshGeneratorWidget", "API Key", None, QtGui.QApplication.UnicodeUTF8))
